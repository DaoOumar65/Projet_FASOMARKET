...
### 5. Intégrer dans CommandeService

```java
@Autowired
private SmsService smsService;

public CommandeCreationResponse creerCommande(CommandeCreationRequest request, String clientId) {
    // ... logique de création de commande ...
    
    // Envoyer SMS de confirmation
    smsService.envoyerSmsConfirmationCommande(
