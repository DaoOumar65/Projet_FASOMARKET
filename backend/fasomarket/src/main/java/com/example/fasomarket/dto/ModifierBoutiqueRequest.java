...
public class ModifierBoutiqueRequest {
    private String nom;
    ...
    public ModifierBoutiqueRequest() {}
    ...
    public static class Builder {
        private ModifierBoutiqueRequest request = new ModifierBoutiqueRequest();

        public Builder livraison(Boolean livraison) {
            request.livraison = livraison;
            return this;
        }

        public Builder fraisLivraison(BigDecimal fraisLivraison) {
            request.fraisLivraison = fraisLivraison;
            return this;
        }

        public ModifierBoutiqueRequest build() {
            return request;
        }
    }
